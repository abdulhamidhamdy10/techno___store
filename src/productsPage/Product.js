    ...
    const products = [
        {
            ...
            "image_url": "/images/Apple-Macbook-Pro-13_-5-e1597745110243.png",
        ...
        },
        {
            ...
            "image_url": "/images/c595c9dc092cb7fbfecedde02a6952ae.png",
        ...
        },
        {
            ...
            "image_url": "/images/MacBook_Notebook_Computer_PNG_Clipart-749.png",
        ...
        },
        {
            ...
            "image_url": "/images/macbook_PNG35.png",
            "name": "Apple 2023 MacBook",
            "price": 500,
            "id": 4,
        },
        {
            ...
            "image_url": "/images/macbook_PNG101747.png",
            "name": "Apple 2020 MacBook",
            "price": 500,
            "id": 5,
        },
        {
            ...
            "image_url": "/images/macbook-pro-m1-14-header.png",
            "name": "Apple 2023 MacBook",
            "price": 500,
            "id": 6,
        },
        {
            ...
            "image_url": "/images/4MdfxeCXns9oQps7zkmXjf.png",
        ...
        },
        {
            ...
            "image_url": "/images/774-7748947_leptop-png.png",
        ...
        },
        {
            ...
            "image_url": "/images/Dell-Laptop-PNG-Picture.png",
        ...
        },
        {
            ...
            "image_url": "/images/dg7700nt_cnb_05000ff090_bk-1480x1206.png",
        ...
        },
        {
            ...
            "image_url": "/images/laptop-transparent-png-13.png",
        ...
        },
        {
            ...
            "image_url": "/images/33378-2-asus-laptop-transparent.png",
        ...
        },
        {
            ...
            "image_url": "/images/asus-rog-zephyrus-duo.png",
        ...
        },
        {
            ...
            "image_url": "/images/se1_p5_img_6.png",
        ...
        <div className="products">
            <Container>
                <Row className="rowone">
                    ...
                    {products.map((dev) => (
                        <Col data-wow-delay="0.1s" className='img-fluid  center' md="4" key={dev.id}>
                            <div className="colone ">
                                <h1 className="mt-3" >{dev.name}</h1>
                                <img src={dev.image_url} ></img>
                                ...
                                <h6 style={{ marginTop: "20px" }}>
                                    ...
                                    <i class="fa-solid fa-star" style={{ color: "#fff200" , fontSize :"20px"}}></i>
                                    <i class="fa-solid fa-star" style={{ color: "#fff200" , fontSize :"20px"}}></i>
                                    <i class="fa-solid fa-star" style={{ color: "#fff200" , fontSize :"20px"}}></i>
                                    <i class="fa-solid fa-star" style={{ color: "#fff200" , fontSize :"20px"}}></i>
                                    <i class="fa-solid fa-star" style={{ color: "#fff200", marginRight: "10px" , fontSize :"20px"}}></i><br />
                                
                                    <h3 className="mt-3">${dev.price}</h3>
                                <button onClick={() => addItem(dev)}>Add to cart</button>
                            </div>
                        </Col>
                    ))}
